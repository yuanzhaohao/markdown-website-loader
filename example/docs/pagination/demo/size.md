...
ReactDOM.render(
  <div className="pagination-wrapper">
    <Pagination total={500} current={10} pageSize={10} size="large" />
    <Pagination total={500} current={10} pageSize={10} size="default" />
    <Pagination total={500} current={10} pageSize={10} size="small" />
  </div>,
  mountNode,
);
```
